...
Да здравствует наш чемпион {d1_sort[0][1]}! Его результативности может позавидовать Элтон Джон и другие Великие.
...
Пожелаем им здоровья, успехов в личной жизни и новых побед.''')
        ...
        await bot.send_message(group_id, '🚨🚨🚨Внимание!🚨🚨🚨 Пидр Клаус подводит итоги...\n'
...
Да здравствует наши ПИДАРАСы года {", ".join(champions)}🎉🎉🎉! В тяжелейшей борьбе они таки вырвали свою заслуженную
победу. Пожелаем им здоровья, успехов в личной жизни и новых побед.''')
